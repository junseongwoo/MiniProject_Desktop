...
namespace NaverMovieFinderApp
{
    ...
    public partial class MainWindow : MetroWindow
    {
        ...
        private void BtnSearch_Click(object sender, RoutedEventArgs e)
        {
            ...
            //Commons.ShowMessageAsync("결과", $"{TxtMovieName.Text}"); // 검색한 내용을 메세지로 띄워줌
        ...
        private void GrdData_SelectedCellsChanged(object sender, System.Windows.Controls.SelectedCellsChangedEventArgs e)
        {
        ...
        private void BtnViewWatchList_Click(object sender, RoutedEventArgs e)
        {
            ...
            //<MovieItem> listData = new List<MovieItem>();
            List<NaverFavoriteMovies> list = new List<NaverFavoriteMovies>();
